...
SECRET_KEY = 'django-insecure-mindjourney-secret-key-change-in-production'
...
WSGI_APPLICATION = 'mindjourney.wsgi.application'
...
# Add React build directory to static files (only if it exists)
STATICFILES_DIRS = []
...
# Optionally keep explicit origins for future tightening
